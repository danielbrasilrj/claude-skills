...
name: figma-handoff
description: >
  Design-to-development handoff skill. Generates component specs, responsive
  breakpoint documentation, accessibility annotations, and design token
  mappings from Figma designs. Framework-agnostic output ready for any
  frontend stack.
---
...
See REFERENCE.md Section 1 for the full token taxonomy.
